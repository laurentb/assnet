...
web build:
 - http://mootools.net/core/3e1a708b8eb0089d8216539af3e4bc7e

packager build:
 - packager build Core/Core Core/Array Core/String Core/Number Core/Event Core/Browser Core/Element.Style Core/Element.Dimensions Core/Request.HTML Core/Request.JSON Core/Cookie Core/DOMReady
...
},periodical:function(c,b,a){return setInterval(this.pass((a==null?[]:a),b),c);}});(function(){var k=this.document;var i=k.window=this;var b=1;this.$uid=(i.ActiveXObject)?function(e){return(e.uid||(e.uid=[b++]))[0];
...
Array[e]=function(q){return p.apply(Array.from(q),n.call(arguments,1));};});}}).call(this);(function(){var a=Object.prototype.hasOwnProperty;Object.extend({subset:function(d,g){var f={};
...
}else{this.event.returnValue=false;}return this;}});(function(){var k,n,l,g,a={},c={},m=/\\/g;var e=function(q,p){if(q==null){return null;}if(q.Slick===true){return q;
...
k[j]={};k.borderWidth[i]=k[j][i]=g[i]="@px";k.borderStyle[f]=k[j][f]=g[f]="@";k.borderColor[h]=k[j][h]=g[h]="rgb(@, @, @)";});}).call(this);(function(){var h=document.createElement("div"),e=document.createElement("div");
...
},getTop:function(){return this.getPosition().y;},getLeft:function(){return this.getPosition().x;}});(function(){var a=this.Class=new Type("Class",function(h){if(instanceOf(h,Function)){h={initialize:h};
